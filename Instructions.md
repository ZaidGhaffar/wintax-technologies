I wanted to add the following Ui to mine web app,make sure not to write all the code in page.tsx that looks messy create a seperaate files in component & than start building it:
